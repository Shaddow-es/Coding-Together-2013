...
{
    [super viewDidLoad];
    // Establece el método a ejecutar cuando se utiliza el refreshcontrol de la tabla
...
- (void) reload
{
    // Limpia el array de fotografías
    ...
    dispatch_async(imageFetcherQ, ^{
        ...
        for (NSDictionary *photoDict in photosDict) {
            ...
            // Filtra los tags de la fotografía eliminando los que no son necesarios
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            // Para el spinner del refresh control
