...
//  Attribute
//
//  Created by David Muñoz Fernández on 07/02/13.
...
- (IBAction)outline
{
    [self addSelectedWordAttributes:@{ NSStrikethroughStyleAttributeName : @(NSUnderlineStyleSingle)}];
}

- (IBAction)unOutline
{
    [self addSelectedWordAttributes:@{ NSStrikethroughStyleAttributeName : @(NSUnderlineStyleNone)}];
}
